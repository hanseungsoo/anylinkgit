...
/**
 * @file              hss.r_hss_db.l_sync_db.M_DB_ARR.java
...
public class M_DB_ARR extends ProMapperDataObject implements ResourceMeta {
    ...
    public void setCNT(int CNT, boolean _masked) {
        ...
        private ArrayList<hss.r_hss_db.l_sync_db.M_DB_DATA> ARR = new ArrayList<hss.r_hss_db.l_sync_db.M_DB_DATA>();
    ...
    public void createARR(int _size) {
        ...
        for(int i = ARR.size(); i < _size; i++) {
            ARR.add(new hss.r_hss_db.l_sync_db.M_DB_DATA());
        }
    }
    ...
    public hss.r_hss_db.l_sync_db.M_DB_DATA[] getARR() {
        return (hss.r_hss_db.l_sync_db.M_DB_DATA[])ARR.toArray(new hss.r_hss_db.l_sync_db.M_DB_DATA[ARR.size()]);
    }
    public hss.r_hss_db.l_sync_db.M_DB_DATA getARR(int _index) {
        return ARR.get(_index);
    }
    
    public void setARR(hss.r_hss_db.l_sync_db.M_DB_DATA[] ARR) {
        this.ARR.clear();
    ...
    public void setARR(int _index, hss.r_hss_db.l_sync_db.M_DB_DATA ARR) {
        this.ARR.set(_index, ARR);
        _setFlag = true;
    }
    
    public void addARR(int _index, hss.r_hss_db.l_sync_db.M_DB_DATA ARR) {
        this.ARR.add(_index, ARR);
        _setFlag = true;
    }
    public void addARR(hss.r_hss_db.l_sync_db.M_DB_DATA ARR) {
        this.ARR.add(ARR);
        _setFlag = true;
    }
    
    public hss.r_hss_db.l_sync_db.M_DB_DATA removeARR(int _index) {
    ...
    public void clone(proframe.dto.DataObject __m_DB_ARR) {
        ...
        for (int index0 = 0; index0 < getARR().length; index0++) {
            _m_DB_ARR.addARR(index0, (hss.r_hss_db.l_sync_db.M_DB_DATA)getARR(index0).clone());
        }
    }
...
/*    static {
        ...
        fieldPropertyMap.put("ARR"
                            , FieldPropertyFactory.getFieldProperty( FieldProperty.TYPE_ABSTRACT_INCLUDE, -1, "CNT" , "hss.r_hss_db.l_sync_db.M_DB_DATA"));
    }*/
    ...
    public void set(String fieldName, Object arg) {
        ...
        switch(hashCode) {
            ...
            case 65089 : setARR((hss.r_hss_db.l_sync_db.M_DB_DATA[])arg);break;
            default : return;
        }
    }
    /**
    ...
    public String getMetaData(String input) {
        ...
        if (input.equalsIgnoreCase(META_PHYSICAL_NAME)) {
            ...
            return "hss.r_hss_db.l_sync_db:M_DB_ARR.umsg";
