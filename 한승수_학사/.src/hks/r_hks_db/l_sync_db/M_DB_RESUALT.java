...
/**
 * @file              hks.r_hks_db.l_sync_db.M_DB_RESUALT.java
...
public class M_DB_RESUALT extends ProMapperDataObject implements ResourceMeta {
    ...
    public Object clone() {
        M_DB_RESUALT copyObj = new M_DB_RESUALT();    
        clone(copyObj);        
        return copyObj;
    }
    public void clone(proframe.dto.DataObject __m_DB_RESUALT) {
        M_DB_RESUALT _m_DB_RESUALT = (M_DB_RESUALT) __m_DB_RESUALT;
        _m_DB_RESUALT.setCNT(CNT);
        _m_DB_RESUALT.setMSG(MSG);
    }
...
/*    static {
    ...
    public String getMetaData(String input) {
        ...
        if (input.equalsIgnoreCase(META_PHYSICAL_NAME)) {
            ...
            return "hks.r_hks_db.l_sync_db:M_DB_RESUALT.umsg";
