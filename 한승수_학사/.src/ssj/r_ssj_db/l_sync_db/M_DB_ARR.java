...
/**
 * @file              ssj.r_ssj_db.l_sync_db.M_DB_ARR.java
...
public class M_DB_ARR extends ProMapperDataObject implements ResourceMeta {
    ...
    public void setCNT(int CNT, boolean _masked) {
        ...
        private ArrayList<ssj.r_ssj_db.l_sync_db.M_DB_DATA> ARR = new ArrayList<ssj.r_ssj_db.l_sync_db.M_DB_DATA>();
    ...
    public void createARR(int _size) {
        ...
        for(int i = ARR.size(); i < _size; i++) {
            ARR.add(new ssj.r_ssj_db.l_sync_db.M_DB_DATA());
        }
    }
    ...
    public ssj.r_ssj_db.l_sync_db.M_DB_DATA[] getARR() {
        return (ssj.r_ssj_db.l_sync_db.M_DB_DATA[])ARR.toArray(new ssj.r_ssj_db.l_sync_db.M_DB_DATA[ARR.size()]);
    }
    public ssj.r_ssj_db.l_sync_db.M_DB_DATA getARR(int _index) {
        return ARR.get(_index);
    }
    
    public void setARR(ssj.r_ssj_db.l_sync_db.M_DB_DATA[] ARR) {
        this.ARR.clear();
    ...
    public void setARR(int _index, ssj.r_ssj_db.l_sync_db.M_DB_DATA ARR) {
        this.ARR.set(_index, ARR);
        _setFlag = true;
    }
    
    public void addARR(int _index, ssj.r_ssj_db.l_sync_db.M_DB_DATA ARR) {
        this.ARR.add(_index, ARR);
        _setFlag = true;
    }
    public void addARR(ssj.r_ssj_db.l_sync_db.M_DB_DATA ARR) {
        this.ARR.add(ARR);
        _setFlag = true;
    }
    
    public ssj.r_ssj_db.l_sync_db.M_DB_DATA removeARR(int _index) {
    ...
    public void clone(proframe.dto.DataObject __m_DB_ARR) {
        ...
        for (int index0 = 0; index0 < getARR().length; index0++) {
            _m_DB_ARR.addARR(index0, (ssj.r_ssj_db.l_sync_db.M_DB_DATA)getARR(index0).clone());
        }
    }
...
/*    static {
        ...
        fieldPropertyMap.put("ARR"
                            , FieldPropertyFactory.getFieldProperty( FieldProperty.TYPE_ABSTRACT_INCLUDE, -1, "CNT" , "ssj.r_ssj_db.l_sync_db.M_DB_DATA"));
    }*/
    ...
    public void set(String fieldName, Object arg) {
        ...
        switch(hashCode) {
            ...
            case 65089 : setARR((ssj.r_ssj_db.l_sync_db.M_DB_DATA[])arg);break;
            default : return;
        }
    }
    /**
    ...
    public String getMetaData(String input) {
        ...
        if (input.equalsIgnoreCase(META_PHYSICAL_NAME)) {
            ...
            return "ssj.r_ssj_db.l_sync_db:M_DB_ARR.umsg";
